...
2. Add to your SillyTavern extensions folder.  (Example: YourInstallationPathHere\SillyTavern-1.13.1\SillyTavern-1.13.1\data\default-user\extensions\romance-meter
...
### After enabling it in the extension settings it should appear like this:
